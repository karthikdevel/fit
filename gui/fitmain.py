...
class FitTopFrame(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        user_static_box= wx.StaticBox(panel, wx.ID_ANY, "User List")
        user_listbox_sizer = wx.StaticBoxSizer(user_static_box,wx.VERTICAL)
        process_static_box= wx.StaticBox(panel, wx.ID_ANY, label="Process List")
        process_listbox_sizer = wx.StaticBoxSizer(process_static_box,wx.VERTICAL)
        param_static_box= wx.StaticBox(panel, wx.ID_ANY, label="Param List")
        ...
        user_listbox_sizer.Add(self.user_listbox, proportion = 1, flag = wx.ALL | wx.EXPAND, border = 10)
        user_listbox_sizer.Add(self.all_user_cb, 0, wx.BOTTOM | wx.CENTER)
        process_listbox_sizer.Add(self.process_listbox, proportion = 1,  flag = wx.ALL | wx.EXPAND, border = 10)
        process_listbox_sizer.Add(self.all_process_cb, 0, wx.BOTTOM | wx.CENTER)
        param_listbox_sizer.Add(self.param_listbox, proportion = 1,  flag = wx.ALL | wx.EXPAND, border = 10)

        # Add Each list box to main grid sizer.
        main_grid_sizer.Add(user_listbox_sizer, proportion = 1,  flag = wx.ALL | wx.EXPAND | wx.ALIGN_TOP)

        main_grid_sizer.Add(process_listbox_sizer, proportion = 1, flag = wx.ALL | wx.EXPAND | wx.ALIGN_TOP)

        main_grid_sizer.Add(param_listbox_sizer, proportion = 1, flag = wx.ALL | wx.EXPAND | wx.ALIGN_TOP)
        
        # Static box for each type of plot (Summary,Time plots & Scatter plots)
        summary_plot_static_box= wx.StaticBox(panel, wx.ID_ANY, "Summary")
        summary_plot_buttons_sizer = wx.StaticBoxSizer(summary_plot_static_box,wx.VERTICAL)

        time_plot_static_box= wx.StaticBox(panel, wx.ID_ANY, "Time")
        time_plot_buttons_sizer = wx.StaticBoxSizer(time_plot_static_box,wx.VERTICAL)

        scatter_plot_static_box= wx.StaticBox(panel, wx.ID_ANY, "Scatter")
        ...
        summary_plot_buttons_sizer.Add(self.user_vs_param_summary_btn, proportion = 1, flag = wx.ALL | wx.EXPAND, border = 10)
        summary_plot_buttons_sizer.Add(self.process_vs_param_summary_btn, proportion = 1, flag = wx.ALL | wx.EXPAND, border = 10)        
        ...
        time_plot_buttons_sizer.Add(self.peruserparam_vs_time_btn, proportion = 1, flag = wx.ALL | wx.EXPAND, border = 10)
        time_plot_buttons_sizer.Add(self.perprocessparam_vs_time_btn, proportion = 1, flag = wx.ALL | wx.EXPAND, border = 10)

        self.user_vs_process_btn = wx.Button(panel, wx.ID_ANY, 'User vs Process')
        
        scatter_plot_buttons_sizer.Add(self.user_vs_process_btn, proportion = 1, flag = wx.ALL | wx.EXPAND, border = 10)
        
        # Add each plot category to the correct grid.
        main_grid_sizer.Add(summary_plot_buttons_sizer, proportion = 1, flag = wx.ALL | wx.EXPAND | wx.ALIGN_TOP)
        main_grid_sizer.Add(time_plot_buttons_sizer, proportion = 1, flag = wx.ALL | wx.EXPAND | wx.ALIGN_TOP)
        main_grid_sizer.Add(scatter_plot_buttons_sizer, proportion = 1, flag = wx.ALL | wx.EXPAND | wx.ALIGN_TOP)
